/*
    This file is modified (by me) from the original source (not written by me)
    Original source: https://github.com/code-tom-code/d3d9shadervalidator/blob/master/d3d9_shadervalidator.h
*/
...
typedef void (__stdcall *IDirect3DShaderValidator9_InstructionCallback)(LPCSTR unknownString, unsigned int unknownUINT, DWORD messageCategoryFlags, D3DSVERROR_ID errorID, LPCSTR messageString, LPVOID lParam);

typedef struct IDirect3DShaderValidator9 
{ 
    struct IDirect3DShaderValidator9Vtbl *lpVtbl; 

} IDirect3DShaderValidator9; 

typedef struct IDirect3DShaderValidator9Vtbl IDirect3DShaderValidator9Vtbl; 

struct IDirect3DShaderValidator9Vtbl
{
	long (__stdcall *QueryInterface)(IDirect3DShaderValidator9* This, REFIID riid, void** ppvObj);
	unsigned long (__stdcall *AddRef)(IDirect3DShaderValidator9* This);
	unsigned long (__stdcall *Release)(IDirect3DShaderValidator9* This);

	long (__stdcall *Begin)(IDirect3DShaderValidator9* This, IDirect3DShaderValidator9_InstructionCallback lpCallbackFunc, void* lParam, unsigned long unknown);

	long (__stdcall *Instruction)(IDirect3DShaderValidator9* This, const char* name, unsigned int line, const unsigned long* pdwInst, unsigned long dwCount) ;

	long (__stdcall *End)(IDirect3DShaderValidator9* This);
};

typedef IDirect3DShaderValidator9* (__stdcall *Direct3DShaderValidatorCreate9Type)(void);